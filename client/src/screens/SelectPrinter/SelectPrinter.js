...
import ItemList from '../../components/SelectPrinter/ItemList';
  ...
  const scan = useCallback(() => {
    try {
      async function blueTooth() {
        const permissions = {
          title: 'HSD bluetooth solicita permiso para acceder a bluetooth',
          message:
            'HSD bluetooth requiere acceso a bluetooth para el proceso de conexión a impresora bluetooth',
          buttonNeutral: 'Otros tiempos',
          buttonNegative: 'No',
